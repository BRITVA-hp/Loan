...
/*#__PURE__*/
function () {
  function VidePlayer(triggers, overlay) {
    _classCallCheck(this, VidePlayer);
...
function (_Slider) {
  ...
  function MainSlider(btns, moreNext, morePrev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, moreNext, morePrev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.morePrev.forEach(function (item) {
      ...
      this.moreNext.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$moreNext = _ref.moreNext,
      moreNext = _ref$moreNext === void 0 ? null : _ref$moreNext,
      _ref$morePrev = _ref.morePrev,
      morePrev = _ref$morePrev === void 0 ? null : _ref$morePrev,
  ...
  this.moreNext = document.querySelectorAll(moreNext);
  this.morePrev = document.querySelectorAll(morePrev);
